...
Begin VB.Form lista_oc 
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   5235
      Left            =   120
      OleObjectBlob   =   "Lista_oc.frx":A645
      TabIndex        =   2
      Top             =   1080
      Width           =   14775
   End
   Begin DXSIDEBARLibCtl.dxSideBar dxSideBar 
      Height          =   555
      Left            =   0
      OleObjectBlob   =   "Lista_oc.frx":152DA
      TabIndex        =   3
      Top             =   6600
      Visible         =   0   'False
      Width           =   840
   ...
   Begin MSComctlLib.ImageList imgLstEstado 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1AA94
            Key             =   "Estado 1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1B02E
            Key             =   "Estado 2"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1B5C8
            Key             =   "Estado 3"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1BB62
            Key             =   "Estado 4"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1C0FC
            Key             =   "Estado 5"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1C696
            Key             =   "Estado 6"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1CC30
            Key             =   "Estado 7"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Lista_oc.frx":1D1CA
            Key             =   "Estado 8"
         EndProperty
      EndProperty
   End
