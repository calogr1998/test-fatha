...
Begin VB.Form solicitud 
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cmbestado 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "solicitud.frx":004D
            Left            =   1380
            List            =   "solicitud.frx":004F
            Locked          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   3
            Top             =   1170
      ...
      Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars2 
         ...
         ToolBarsCount   =   1
         ToolsCount      =   9
         Tools           =   "solicitud.frx":0051
         ToolBars        =   "solicitud.frx":7216
      End
      Begin DXDBGRIDLibCtl.dxDBGrid Grid 
         Height          =   4365
         Left            =   0
         OleObjectBlob   =   "solicitud.frx":72FE
         TabIndex        =   5
         Top             =   2640
         Width           =   17175
      End
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolsCount      =   10
      ActiveColors    =   -1  'True
      Tools           =   "solicitud.frx":FC4B
      ToolBars        =   "solicitud.frx":17AAC
   End
End
...
Dim amovs_det(0 To 25)  As a_grabacion
    ...
    Select Case Tool.Id
        ...
        Case "ID_Grabar":
            ...
            If sw_cabecera = True Or sw_detalle = True Then
                ...
                Else
                    grabar
'                If MsgBox("¿Enviar correo para aprobación del requerimiento?", vbQuestion + vbYesNo, "Sistema de Logística") Then
...
Dim z As Integer
    ...
    'RSDETALLE.Open "SELECT COUNT(ITEM) AS NITEM FROM " & cnomtabla & " WHERE LEN(TRIM(COD_PRODUCTO)) > 0 OR NOT ISNULL(COD_PRODUCTO)", cnn_form, adOpenDynamic, adLockOptimistic
...
'            If Len(Trim(RSDETALLE.Fields("COD_PRODUCTO") & "")) > 0 Then
'                Values(0, nfil) = txtsolicitud.Text
'                Values(1, nfil) = Val(RSDETALLE.Fields("ITEM") & "")
'                Values(2, nfil) = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                If ctipo = "A" Then
'                    Values(3, nfil) = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                    cantidad = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                Else
'                    If IsNull(RSDETALLE.Fields("CANDIS")) Then
'                        Values(3, nfil) = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                        cantidad = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                    Else
'                        If Val(RSDETALLE.Fields("CANDIS") & "") = Val(RSDETALLE.Fields("CANT_ANT") & "") Then
'                            Values(3, nfil) = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                            cantidad = Val(RSDETALLE.Fields("DS_CANTIDAD") & "")
'                        Else
'                            Values(3, nfil) = Val(RSDETALLE.Fields("CANDIS") & "")
'                            cantidad = Val(RSDETALLE.Fields("CANDIS") & "")
'                        End If
'                    End If
'                End If
'                Values(4, nfil) = RSDETALLE.Fields("COD_PRODUCTO") & ""
'                Values(5, nfil) = RSDETALLE.Fields("ds_unidmed") & ""
'                Values(6, nfil) = RSDETALLE.Fields("ds_descripcion") & ""
'                Values(7, nfil) = Val(RSDETALLE.Fields("precio") & "")
'                Values(8, nfil) = Val(RSDETALLE.Fields("presug") & "")
'                Values(9, nfil) = Val(RSDETALLE.Fields("stok") & "")
'                Values(10, nfil) = Format(RSDETALLE.Fields("cs_fentrega") & "", "DD/MM/YYYY")
'                presug = Val(RSDETALLE.Fields("presug") & "")
'                SUBTOTAL = cantidad * presug
'                Values(11, nfil) = SUBTOTAL
'                Values(12, nfil) = "*"
'                Values(13, nfil) = RSDETALLE.Fields("F5MARCA") & ""
'                Values(14, nfil) = RSDETALLE.Fields("F5CODFAB") & ""
'                Values(15, nfil) = RSDETALLE.Fields("F5CODMARCA") & ""
...
'    RSDETALLE.Close
    ...
    cvalores = "11111111111111111111111111"
    ...
    If ctipo = "A" Then     '--- Nuevo
        ...
        If sw_GRABA_REGISTRO_logistica = True Then
            '------- GRABA DETALLE
            GRABA_REGISTRO_logistica_DET amovs_det(), "TB_DETSOLICITUD", ctipo, 25, cnn_dbbancos, "", Values(), nfil - 1, cvalores, "", ""
        End If
        'enviarcorreoAmail
    Else    '--- Modificación
        '------- GRABA CABECERA
        ...
        Else
            ...
            Actualiza_Log sql, cnn_dbbancos.ConnectionString
        End If
        GRABA_REGISTRO_logistica_DET amovs_det(), "TB_DETSOLICITUD", "A", 25, cnn_dbbancos, "cod_solicitud = '" & cnumvale & "'", Values(), nfil - 1, cvalores, "", ""
    End If
    '-------------------------------------------------------
    Exit Sub
...
cuerpo = cargacuerpo(txtsolicitud.Text)
            ...
            'MsgBox ("Su solicitud de aprobación está siendo enviada."), vbInformation, "CONTROLPLUS!"
            Me.MousePointer = 11
...
Dim TIPO            As String
    ...
    '        aux.Close
            ...
            Else
                sql = "select item,cod_producto,ds_descripcion,ds_unidmed,ds_cantidad,stok,precio,f3pordct, " _
                & "presug,cs_fentrega,candis,f5marca,f5codfab,F5CODMARCA,f5CONigv,f5SINigv,F5AFECTO,ruc_proveedor,F5CODCOSTO,centro, proveedor,observa from tb_detsolicitud " _
            ...
            If Not (rst.EOF) Then
                ...
                Do While Not (rst.EOF)
                    ...
                    Grid.Dataset.FieldValues("DS_desUNIMED") = ObtenerCampo("ef7medidas", "f7sigmed", "f7codmed", rst!ds_unidmed & "", "T", cnn_dbbancos)
