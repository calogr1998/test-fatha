...
KnappStatus = 3
    Operator_Click 4
    moms = Readout * wigv / 100
    Readout = Readout * (1 + wigv / 100)
'Aligment wright
SendMessage lstKvitto.hwnd, LB_SETTABSTOPS, 1, mTabs(0)
    lstKvitto.AddItem vbTab & "vat   + " + moms
    lstKvitto.AddItem vbTab & "= " + Readout
