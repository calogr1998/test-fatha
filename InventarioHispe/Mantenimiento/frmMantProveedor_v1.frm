...
''------------ SQL ---------------------------------------------------------------------------------------------
''--------------------------------------------------------------------------------------------------------------
Private Sub consultarProveedorSql()
    Set objSqlProveedor = New SqlClsProveedor
    
    limpiarCajas
    
    With objSqlProveedor
        .inicializarEntidades
    ...
    Set objSqlProveedor = Nothing
End Sub

Private Sub guardarProveedorSql()
    Set objSqlProveedor = New SqlClsProveedor
    ...
    With objSqlProveedor
        ...
        .NumeroDocumento = Trim(txtNroDocumento.Text)
        .Codigo = strCodProveedor 'Trim(txtCodigo.Text)
        .NombreProveedor = Replace(Trim(txtRazonSocial.Text), "'", "´", 1)
        .DireccionProveedor = Replace(Trim(txtDireccionFiscal.Text), "'", "´", 1)
        .CodigoDistrito = right(cmbDistrito.Text, 2)
        .CodigoExterno = Trim(txtCodigoExterno.Text)
        ...
        .Email = Trim(txtEmail.Text)
        .Web = Trim(txtWeb.Text)
        .Contacto = Replace(Trim(txtContacto.Text), "'", "´", 1)
...
Private Sub eliminarProveedorSql()
    Set objSqlProveedor = New SqlClsProveedor
