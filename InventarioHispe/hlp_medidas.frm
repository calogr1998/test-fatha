...
Begin VB.Form hlp_medidas 
   Appearance      =   0  'Flat
   Caption         =   "Lista de Unidades de Medida"
   ClientHeight    =   4140
   ClientLeft      =   1680
   ClientTop       =   1620
   ClientWidth     =   5100
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid 
         ...
         Columns(0).DataField=   "F7CODMED"
         Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(1)._VlistStyle=   0
         Columns(1)._MaxComboItems=   5
         Columns(1).Caption=   "Descripción"
         Columns(1).DataField=   "F7NOMMED"
...
Private Sub Form_Activate()
    ...
    DataAyuda.RecordSource = "Select * FROM EF7MEDIDAS ORDER BY F7CODMED"
    DataAyuda.Refresh

    If DataAyuda.Recordset.RecordCount = 0 Then
        MsgBox "No se ingresaron unidades de medida", 64, "Lista de Medidas"
        Unload Me
    Else
        DataGrid.SetFocus
    End If
