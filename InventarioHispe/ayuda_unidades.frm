...
Begin VB.Form ayuda_unidades 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda de Unidades de Medidas"
   ClientHeight    =   5925
   ClientLeft      =   6675
   ClientTop       =   3060
   ClientWidth     =   5025
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_unidades.frx":058A
      ToolBars        =   "ayuda_unidades.frx":6AB6
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4380
      Left            =   120
      OleObjectBlob   =   "ayuda_unidades.frx":6B84
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
End
Attribute VB_Name = "ayuda_unidades"
...
Private Sub dxDBGrid1_OnDblClick()
    wcodmed = dxDBGrid1.Columns.ColumnByFieldName("f7codmed").value
    txtBusqueda.Text = ""
    Me.Hide
End Sub
...
Private Sub FILL()
    csql = "Select F7CODMED,F7NOMMED FROM EF7MEDIDAS ORDER BY F7CODMED"
