...
Begin VB.Form lista_oc 
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   5235
      Left            =   120
      OleObjectBlob   =   "Lista_oc.frx":7FB9
      TabIndex        =   2
      Top             =   1140
      Width           =   14775
   End
   Begin DXSIDEBARLibCtl.dxSideBar dxSideBar 
      Height          =   675
      Left            =   240
      OleObjectBlob   =   "Lista_oc.frx":10A58
      TabIndex        =   3
      Top             =   6600
      Visible         =   0   'False
      Width           =   1440
...
Private Sub Form_Activate()
    ...
    'Else
        SSActiveToolBars1.Tools.ITEM("ID_NuevoO.CompraMúltiple").Visible = False
