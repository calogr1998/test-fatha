...
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} acr_kardex_nv 
   Caption         =   "Logistica_Suma - acr_kardex_nv (ActiveReport)"
   ClientHeight    =   8490
   ClientLeft      =   480
   ClientTop       =   1785
   ClientWidth     =   13725
   Icon            =   "acr_kardex_nv.dsx":0000
   WindowState     =   2  'Maximized
   _ExtentX        =   24209
   _ExtentY        =   14975
   SectionData     =   "acr_kardex_nv.dsx":058A
End
...
Private Sub Detail_BeforePrint()
    ...
    wcant = 0#
    If ant1 < 0 Then
        fldsaldok.ForeColor = vbRed
    Else
        fldsaldok.ForeColor = vbBlack
    End If
