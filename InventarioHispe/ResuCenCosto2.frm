...
Begin VB.Form ResuCenCosto2 
   ...
   Begin Threed.SSFrame SSFrame3 
      ...
      Begin aBoxCtl.aBox abodesde 
         ...
         EndProperty
         ShowButton      =   1
         ButtonPicture   =   "resucencosto2.frx":0000
         ButtonWidth     =   21
         UpDownWidth     =   14
         NullText        =   ""
      ...
      Begin aBoxCtl.aBox abohasta 
         ...
         EndProperty
         ShowButton      =   1
         ButtonPicture   =   "resucencosto2.frx":0352
         ButtonWidth     =   21
         UpDownWidth     =   14
         NullText        =   ""
         BeginProperty CalcBtnFont {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
   ...
   Begin Threed.SSPanel SSPanel2 
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid2 
         Height          =   3570
         Left            =   450
         OleObjectBlob   =   "resucencosto2.frx":06A4
         TabIndex        =   18
         Top             =   4365
         Width           =   9690
      End
      Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
         Height          =   3705
         Left            =   135
         OleObjectBlob   =   "resucencosto2.frx":1FE5
         TabIndex        =   19
         Top             =   180
         Width           =   10005
      End
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   9
      Tools           =   "resucencosto2.frx":3926
      ToolBars        =   "resucencosto2.frx":B816
   End
