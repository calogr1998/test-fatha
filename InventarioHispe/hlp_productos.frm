...
Begin VB.Form hlp_productos 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid 
         Bindings        =   "hlp_productos.frx":0000
         Height          =   3210
         Left            =   90
         TabIndex        =   2
         Top             =   90
         ...
         Columns(11).Caption=   "F5AFECTO"
         Columns(11).DataField=   "F5AFECTO"
         ...
         Splits(0)._ColumnProps(12)=   "Column(1)._ColStyle=65808"
         Splits(0)._ColumnProps(13)=   "Column(1).Order=2"
         Splits(0)._ColumnProps(14)=   "Column(2).Width=3519"
         Splits(0)._ColumnProps(15)=   "Column(2).DividerColor=0"
         Splits(0)._ColumnProps(16)=   "Column(2)._WidthInPix=3440"
         Splits(0)._ColumnProps(17)=   "Column(2)._EditAlways=0"
         Splits(0)._ColumnProps(18)=   "Column(2)._ColStyle=65792"
         Splits(0)._ColumnProps(19)=   "Column(2).Order=3"
         Splits(0)._ColumnProps(20)=   "Column(3).Width=7938"
         Splits(0)._ColumnProps(21)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(22)=   "Column(3)._WidthInPix=7858"
         Splits(0)._ColumnProps(23)=   "Column(3)._EditAlways=0"
         Splits(0)._ColumnProps(24)=   "Column(3).AllowSizing=0"
         Splits(0)._ColumnProps(25)=   "Column(3)._ColStyle=65808"
         ...
         Splits(0)._ColumnProps(29)=   "Column(4)._WidthInPix=1667"
         Splits(0)._ColumnProps(30)=   "Column(4)._EditAlways=0"
         Splits(0)._ColumnProps(31)=   "Column(4).AllowSizing=0"
         Splits(0)._ColumnProps(32)=   "Column(4)._ColStyle=73730"
         ...
         Splits(0)._ColumnProps(63)=   "Column(9).Width=2699"
         Splits(0)._ColumnProps(64)=   "Column(9).DividerColor=0"
         Splits(0)._ColumnProps(65)=   "Column(9)._WidthInPix=2619"
         ...
         Splits(0)._ColumnProps(80)=   "Column(11)._ColStyle=65792"
         ...
         _StyleDefs(79)  =   "Splits(0).Columns(11).Style:id=82,.parent=43"
         _StyleDefs(80)  =   "Splits(0).Columns(11).HeadingStyle:id=79,.parent=44"
         _StyleDefs(81)  =   "Splits(0).Columns(11).FooterStyle:id=80,.parent=45"
         _StyleDefs(82)  =   "Splits(0).Columns(11).EditorStyle:id=81,.parent=47"
   ...
   End
End
Attribute VB_Name = "hlp_productos"
