...
Begin VB.Form hlp_marcas 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid 
         ...
         Columns(0).DataField=   "F2CODMAR"
         Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(1)._VlistStyle=   0
         Columns(1)._MaxComboItems=   5
         Columns(1).Caption=   "Descripción"
         Columns(1).DataField=   "F2DESMAR"
         ...
         Splits(0)._ColumnProps(8)=   "Column(1).Width=5371"
         Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=5292"
         ...
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=16,.bold=-1,.fontsize=825,.italic=0"
...
Private Sub Form_Activate()
    ...
    If Len(Trim(sw_ayuda_marca)) > 0 Then
        DataAyuda.RecordSource = "Select F2CODMAR, F2DESMAR FROM EF2MARCAS WHERE F2ORIGEN='" & sw_ayuda_marca & "' ORDER BY F2DESMAR"
    Else
        DataAyuda.RecordSource = "Select F2CODMAR, F2DESMAR FROM EF2MARCAS ORDER BY F2DESMAR"
    End If
    DataAyuda.Refresh
