...
Begin VB.Form ayuda_embarcadores 
   Caption         =   "Ayuda de Embarcadores"
   ClientHeight    =   5745
   ClientLeft      =   4365
   ClientTop       =   2505
   ClientWidth     =   8535
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_embarcadores.frx":0000
      ToolBars        =   "ayuda_embarcadores.frx":652C
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4245
      Left            =   120
      OleObjectBlob   =   "ayuda_embarcadores.frx":663F
      TabIndex        =   3
      Top             =   960
      Width           =   8235
   End
End
Attribute VB_Name = "ayuda_embarcadores"
...
Private Sub dxDBGrid1_OnDblClick()
    wcodpag = "" & dxDBGrid1.Columns.ColumnByFieldName("f2codprov").value
    wrucprov = "" & dxDBGrid1.Columns.ColumnByFieldName("f2newruc").value
    wnompag = "" & dxDBGrid1.Columns.ColumnByFieldName("f2nomprov").value
...
Else
    ...
    csql = "SELECT EF2PROVEEDORES.F2CODPROV, EF2PROVEEDORES.F2NEWRUC, EF2PROVEEDORES.F2NOMPROV, EF2PROVEEDORES.F2FORPAG, "
    csql = csql & "EF2PROVEEDORES.F2CONTACTO, EF2PROVEEDORES.F2TIPMON, EF2PROVEEDORES.F2TELPROV "
    csql = csql & "FROM EF2PROVEEDORES INNER JOIN EF2EMBARCADORES ON EF2PROVEEDORES.F2NEWRUC = EF2EMBARCADORES.F2NEWRUC "
