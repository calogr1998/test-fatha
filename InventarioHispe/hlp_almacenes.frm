...
Begin VB.Form hlp_almacenes 
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   1
      Tools           =   "hlp_almacenes.frx":0000
      ToolBars        =   "hlp_almacenes.frx":0073
   End
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid dbgrid1 
         Bindings        =   "hlp_almacenes.frx":00ED
         Height          =   3000
         Left            =   180
         TabIndex        =   1
         Top             =   150
   ...
   End
End
Attribute VB_Name = "hlp_almacenes"
...
Private Sub MostrarGrid()
    ...
    cValSql = "SELECT F2CODALM, F2NOMALM FROM EF2ALMACENES ORDER BY F2CODALM"
    ...
    '
    dbgrid1.Columns(0).DataField = "F2CODALM"
    dbgrid1.Columns(1).DataField = "F2NOMALM"
...
Private Sub Elegir()
    wnomalmacen = dbgrid1.Columns(1)
    wcod_alm = dbgrid1.Columns(0)
    Unload Me
End Sub
