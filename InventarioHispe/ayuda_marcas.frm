...
Begin VB.Form ayuda_marcas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda de Marcas"
   ClientHeight    =   5925
   ClientLeft      =   3765
   ClientTop       =   1395
   ClientWidth     =   5025
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_marcas.frx":058A
      ToolBars        =   "ayuda_marcas.frx":6AB6
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4380
      Left            =   120
      OleObjectBlob   =   "ayuda_marcas.frx":6BC9
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
End
Attribute VB_Name = "ayuda_marcas"
...
Private Sub dxDBGrid1_OnDblClick()
    wcodmar = dxDBGrid1.Columns.ColumnByFieldName("f2codmar").value
...
Private Sub FILL()
    csql = "Select F2CODMAR, F2DESMAR FROM EF2MARCAS ORDER BY F2DESMAR"
    
    dxDBGrid1.Dataset.Active = False
    dxDBGrid1.Dataset.ADODataset.CommandText = csql
    dxDBGrid1.Dataset.Active = True
    dxDBGrid1.KeyField = "F2DESMAR"
End Sub
