...
Begin VB.Form Cotizacion 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin ActiveToolBars.SSActiveToolBars atbmenu 
         ...
         ToolBarsCount   =   1
         ToolsCount      =   9
         Tools           =   "Cotizacion.frx":000C
         ToolBars        =   "Cotizacion.frx":71C9
      End
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cmbmone 
         Height          =   330
         ItemData        =   "Cotizacion.frx":73CE
         Left            =   10620
         List            =   "Cotizacion.frx":73D8
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   1416
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid Grid 
      Height          =   3525
      Left            =   0
      OleObjectBlob   =   "Cotizacion.frx":73EC
      TabIndex        =   12
      Top             =   3780
      Width           =   18495
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   1365
      Left            =   0
      OleObjectBlob   =   "Cotizacion.frx":EEE1
      TabIndex        =   60
      Top             =   6060
      Visible         =   0   'False
      Width           =   11715
   ...
   Begin CONTROLSLibCtl.dxCheckBox dxCheckBox1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "Activar Columnas de Descuento"
      Enabled         =   -1  'True
      AutoSize        =   -1  'True
      BackStyle       =   1
      BackColor       =   15790320
...
If Opcion = 1 Then
   ...
   ' MsgBox "Acr_OrdenC_Otros"
        ...
        sql = "SELECT A.F4NUMORD,A.F4NUMCOTIZA,A.F4ESTNUL, A.F4CODSOLICITUD,A.F4TIPDOC, B.F2NOMPROV,  A.F4CODSOL, A.F4CONTACTO, A.F4REGULARIZA,A.F4DIAPAGO,  B.F2TELPROV,  B.F2FAXPROV, " & _
              ...
              "A.F4PLAZO_ENTREGA,A.F4LUGAR_ENTREGA,A.F4ESTADO,A.F4COLOCADA,A.F4FECENT,A.F4OBSERVA,A.F4CODPRV,A.F4TIPMON,A.F4REFERE,A.F4TIPCAM,A.F4FECGRA,A.F4USEGRA,A.F4FECMOD,A.F4USEMOD " & _
        ...
        If Not RSCONSULTA.EOF Then
            ...
            Else
                .LblModifica.Caption = ""
            End If
            If RSCONSULTA!F4COLOCADA = "Verdadero" Then
...
'            .f4emitir3.Text = "Ph: " & wtelefono & "  Fax: " & wfax
        ...
        CadSql = CadSql & "WHERE (((IF3ORDEN.F4NUMORD)='" & GOC & "') AND ((IF3ORDEN.F4LOCAL)='1')) "
...
Dim J               As Integer
    ...
    With Grid
        ...
        csql = csql & "TB_DETSOLICITUD.ds_cantidad-IIf(IsNull(ORDENES.CANT_ORDEN),0,ORDENES.CANT_ORDEN) AS SALDO, TB_DETSOLICITUD.f5SINigv, TB_DETSOLICITUD.f5CONigv, TB_DETSOLICITUD.ruc_proveedor, TB_DETSOLICITUD.F5AFECTO, TB_DETSOLICITUD.f3pordct "
        ...
        If Not (rsSolDet.EOF) Then
            ...
            Do While Not (rsSolDet.EOF)
                If rsSolDet!cod_solicitud = Trim(num_solcomp) And (rsSolDet!ruc_proveedor = Txt_Prove.Text Or IsNull(rsSolDet!ruc_proveedor)) Then
                J = J + 1
                    If J = 1 Then
                        Grid.Dataset.Edit
                    Else
                    ...
                    .Dataset.FieldValues("f3pordesc") = rsSolDet!f3pordct
...
With Grid.Columns
    If right(CmbTipDoc.Text, 2) = "02" Then
        .ColumnByFieldName("F3SINIGV").Caption = "Valor Bruto"
        .ColumnByFieldName("F3CONIGV").Caption = "Valor Neto"
        .ColumnByFieldName("F3IGV").Caption = "Retención"
    Else
        .ColumnByFieldName("F3SINIGV").Caption = "Valor s/IGV"
...
Private Sub dxCheckBox2_Click()
    If dxCheckBox2.Checked = True Then
        dxDBGrid1.Columns.ColumnByFieldName("f3sinigv").DecimalPlaces = 6
    Else
        dxDBGrid1.Columns.ColumnByFieldName("f3sinigv").DecimalPlaces = 2
    End If
End Sub
...
'                    atbmenu.Tools.ITEM("ID_Aprobacion").Visible = True
    ...
    With rsOrdenDet
        sql = "SELECT * from if3orden where f4numord='" & GOC & "' AND F4local = '1' ORDER BY val(ITEM)"
        If rsOrdenDet.State = adStateOpen Then rsOrdenDet.Close
        rsOrdenDet.Open sql, cnn_dbbancos, adOpenDynamic, adLockOptimistic
        If Not (.EOF) Then
            existe = True
    ...
    If Grid.Dataset.RecordCount = 0 Then
        AdicionaItemGrid
    End If
    If lista_oc.dxDBGrid1.Columns.ColumnByFieldName("F4COLOCADA").Value = True Then
        Grid.Enabled = False
    End If
End Sub
...
Dim StrCodCosto As String
    ...
    sql = "SELECT top 1 left(F4NUMORD,12) AS MAYOR FROM IF4ORDEN WHERE F4LOCAL='1'  order by left(F4NUMORD,12) desc" 'and right(f4numord,3) = '" & StrCodCosto & "'
...
Dim amovs_cab(0 To 30)  As a_grabacion
Dim ctipo               As String
...
'        Next
    ...
    If loc = 1 Then
        ...
        amovs_cab(28).campo = "F4REGULARIZA": amovs_cab(28).valor = 0: amovs_cab(28).TIPO = "T"
        amovs_cab(29).campo = "F4DIAPAGO": amovs_cab(29).valor = txtFechaPago.Text: amovs_cab(29).TIPO = "T"
        amovs_cab(30).campo = "F4PAGOPARCIAL": amovs_cab(30).valor = 0: amovs_cab(30).TIPO = "T"
        rsOrdenCab.Close
        
        
        GRABA_REGISTRO_logistica amovs_cab(), "IF4ORDEN", ctipo, 30, cnn_dbbancos, "F4NUMORD = '" & Txt_NumOC.Text & "' AND F4LOCAL = '1'"
