...
Begin VB.Form ayuda_zonas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda de Zonas"
   ClientHeight    =   5925
   ClientLeft      =   6450
   ClientTop       =   2820
   ClientWidth     =   5025
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_zonas.frx":058A
      ToolBars        =   "ayuda_zonas.frx":6AB6
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4380
      Left            =   120
      OleObjectBlob   =   "ayuda_zonas.frx":6B84
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
End
Attribute VB_Name = "ayuda_zonas"
...
Private Sub dxDBGrid1_OnDblClick()
    wcodzona = dxDBGrid1.Columns.ColumnByFieldName("f2codzon").value
    sw_limpia = True
    txtBusqueda.Text = ""
    sw_limpia = False
    Me.Hide
...
Private Sub FILL()
    csql = "Select F2CODZON,F2DESZON FROM EF2ZONAS ORDER BY F2CODZON"
...
Private Sub txtbusqueda_Change()
    ...
    dxDBGrid1.Dataset.Filter = "F2CODZON LIKE '*" & txtBusqueda.Text & "*' OR " & " F2DESZON LIKE '*" & txtBusqueda.Text & "*' "
