...
Begin VB.Form frmlinea3 
   ...
   Begin ActiveToolBars.SSActiveToolBars atbmenu 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   5
      Tools           =   "frmlinea3.frx":0000
      ToolBars        =   "frmlinea3.frx":3F48
   End
   Begin VSFlex7Ctl.VSFlexGrid grdnivel1 
      ...
      FormatString    =   $"frmlinea3.frx":4060
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin Threed.SSPanel pnllinea 
         ...
         Begin Threed.SSPanel SSPanel1 
            ...
            Begin ActiveToolBars.SSActiveToolBars atbmenu2 
               ...
               ToolBarsCount   =   1
               ToolsCount      =   2
               Tools           =   "frmlinea3.frx":40C6
               ToolBars        =   "frmlinea3.frx":5A3A
            End
         End
...
Public wcod2 As String
Public wdes2 As String
...
SQL = "select * from sf7nivel03 where f7nivel01='" & wcod2 & "' and f7nivel02='" & wcod & "' order by f7codcon "
...
SQL = "select max(val(f7codcon)) from sf7nivel03 where f7nivel01='" & wcod2 & "' and f7nivel02='" & wcod & "'"
rst.Open SQL, cnn_dbbancos, adOpenStatic, adLockOptimistic
If Not rst.EOF Then
...
If nuevo Then
    SQL = "insert into sf7nivel03 (f7nivel01, f7nivel02, f7codcon, f7descon) " _
    & "values ('" & wcod2 & "','" & wcod & "','" & txtcodigo.Text & "','" & txtdescripcion.Text & "')"
Else
    SQL = "update sf7nivel03 set f7descon='" & txtdescripcion.Text & "' where f7nivel01='" & wcod2 & "' and f7nivel02='" & wcod & "' and f7codcon='" & txtcodigo.Text & "'"
End If
...
If grdnivel1.Rows > 1 Then
    ...
    If resp = vbYes Then
        SQL = "delete from sf7nivel03 where f7nivel01='" & wcod2 & "' and f7nivel02='" & wcod & "' and f7codcon='" & xcod & "'"
        cnn_dbbancos.Execute SQL
        CargarNivel
    End If
End If
