...
Begin VB.Form frmlinea2 
   ...
   Begin ActiveToolBars.SSActiveToolBars atbmenu 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   5
      Tools           =   "frmlinea2.frx":0000
      ToolBars        =   "frmlinea2.frx":3F48
   End
   Begin VSFlex7Ctl.VSFlexGrid grdnivel1 
      ...
      FormatString    =   $"frmlinea2.frx":405C
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
      ...
      Begin Threed.SSPanel pnllinea 
         ...
         Begin Threed.SSPanel SSPanel1 
            ...
            Begin ActiveToolBars.SSActiveToolBars atbmenu2 
               ...
               ToolBarsCount   =   1
               ToolsCount      =   2
               Tools           =   "frmlinea2.frx":40C2
               ToolBars        =   "frmlinea2.frx":5A36
            End
         End
...
Public wcod As String
Public wdes As String
...
Select Case Tool.Id
    ...
    Case "ideliminar"
        eliminar
    Case "idnivel"
        frmlinea3.wcod2 = wcod
        frmlinea3.wdes2 = wdes
        frmlinea3.wcod = grdnivel1.TextMatrix(grdnivel1.Row, 1)
        frmlinea3.wdes = grdnivel1.TextMatrix(grdnivel1.Row, 2)
        frmlinea3.Show vbModal
    Case "idsalir"
...
CargarNivel
Me.Caption = wcod & " " & wdes
End Sub

Public Sub CargarNivel()
If rst.State = adStateOpen Then rst.Close
SQL = "select * from sf7nivel02 where f7nivel01='" & wcod & "' order by f7codcon "
...
SQL = "select max(val(f7codcon)) from sf7nivel02 where f7nivel01='" & wcod & "'"
rst.Open SQL, cnn_dbbancos, adOpenStatic, adLockOptimistic
If Not rst.EOF Then
...
If nuevo Then
    SQL = "insert into sf7nivel02 (f7nivel01, f7codcon, f7descon) " _
    & "values ('" & wcod & "','" & txtcodigo.Text & "','" & txtdescripcion.Text & "')"
Else
    SQL = "update sf7nivel02 set f7descon='" & txtdescripcion.Text & "' where f7nivel01='" & wcod & "' and f7codcon='" & txtcodigo.Text & "'"
End If
...
If grdnivel1.Rows > 1 Then
    ...
    If resp = vbYes Then
        SQL = "select * from sf7nivel03 where f7nivel01='" & wcod & "' and f7nivel02='" & xcod & "'"
        If rst.State = adStateOpen Then rst.Close
        rst.Open SQL, cnn_dbbancos, adOpenStatic, adLockOptimistic
        If Not rst.EOF Then
        ...
        SQL = "delete from sf7nivel02 where f7nivel01='" & wcod & "' and f7codcon='" & xcod & "'"
        cnn_dbbancos.Execute SQL
        CargarNivel
    End If
End If
