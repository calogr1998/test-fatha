...
Begin VB.Form ayuda_usuarios 
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_usuarios.frx":058A
      ToolBars        =   "ayuda_usuarios.frx":6AB6
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4380
      Left            =   120
      OleObjectBlob   =   "ayuda_usuarios.frx":6BA8
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
...
Private Sub dxDBGrid1_OnDblClick()
    wcodusuario = dxDBGrid1.Columns.ColumnByFieldName("f2coduser").value
    wnomusuario = dxDBGrid1.Columns.ColumnByFieldName("f2nomuser").value
    sw_limpia = True
    txtBusqueda.Text = ""
    sw_limpia = False
    Me.Hide
...
End Sub
Private Sub FILL()
    csql = "Select F2CODUSER,ucase(F2NOMUSER) as f2nomuser FROM EF2USERS ORDER BY F2nomUSER"
