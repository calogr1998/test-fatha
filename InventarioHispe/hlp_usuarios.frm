...
Begin VB.Form hlp_usuarios 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid 
         Bindings        =   "hlp_usuarios.frx":0000
         Height          =   2490
         Left            =   90
         TabIndex        =   5
         Top             =   45
   ...
   End
End
Attribute VB_Name = "hlp_usuarios"
...
Private Sub DataGrid_KeyPress(KeyAscii As Integer)
    ...
    Select Case KeyAscii
        Case 13:
            wcodusuario = DataGrid.Columns(0)
            wnomusuario = DataGrid.Columns(1)
            Unload Me
        Case 27:
            wcodusuario = ""
            wnomusuario = ""
...
Private Sub Form_Load()
    ...
    DataAyuda.RecordSource = "Select * FROM EF2USERS ORDER BY F2CODUSER"
    DataAyuda.Refresh
...
Dim SQL As String
    ...
    If KeyAscii = 13 Then
        If Len(Trim(txtope)) = 0 Then txtope.SetFocus: Exit Sub
