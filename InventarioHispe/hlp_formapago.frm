...
Begin VB.Form hlp_formapago 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid 
         Bindings        =   "hlp_formapago.frx":0000
         Height          =   2490
         Left            =   90
         TabIndex        =   5
         Top             =   0
   ...
   End
End
Attribute VB_Name = "hlp_formapago"
...
Private Sub Form_Load()
    ...
    DataAyuda.RecordSource = "Select * FROM EF2FORPAG WHERE F2TIPO_FP='C' OR F2TIPO_FP='A' ORDER BY F2FORPAG"
    DataAyuda.Refresh
