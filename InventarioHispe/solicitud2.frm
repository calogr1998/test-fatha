...
Begin VB.Form solicitud2 
   ...
   Begin VB.Frame FrameOC 
      ...
      Begin aBoxCtl.aBox txt_fecha 
         ...
         EndProperty
         ShowButton      =   1
         ButtonPicture   =   "solicitud2.frx":000C
         ButtonWidth     =   21
         UpDownWidth     =   14
         NullText        =   ""
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin ActiveToolBars.SSActiveToolBars atbmenu 
         ...
         ToolBarsCount   =   1
         ToolsCount      =   9
         Tools           =   "solicitud2.frx":035E
         ToolBars        =   "solicitud2.frx":751B
      End
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cmbmone 
         Height          =   330
         ItemData        =   "solicitud2.frx":781F
         Left            =   7260
         List            =   "solicitud2.frx":7829
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   600
         Width           =   1416
      ...
      Begin aBoxCtl.aBox abofechaentrega 
         ...
         EndProperty
         ShowButton      =   1
         ButtonPicture   =   "solicitud2.frx":783D
         ButtonWidth     =   21
         UpDownWidth     =   14
         NullText        =   ""
         BeginProperty CalcBtnFont {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
      ...
      Begin Threed.SSPanel PnlNomCosto 
         ...
         BevelOuter      =   1
      End
      Begin aBoxCtl.aBox aBoHoraEntrega 
         Height          =   315
         Left            =   3000
         TabIndex        =   6
         Top             =   300
         ...
         BeginProperty CalendarFont {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         ButtonPicture   =   "solicitud2.frx":7B8F
         ButtonWidth     =   21
         ShowUpDown      =   1
         UpDownWidth     =   13
         NullText        =   ""
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid Grid 
      Height          =   3525
      Left            =   60
      OleObjectBlob   =   "solicitud2.frx":7EE1
      TabIndex        =   15
      Top             =   3780
      Width           =   11655
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   1365
      Left            =   0
      OleObjectBlob   =   "solicitud2.frx":CD45
      TabIndex        =   63
      Top             =   6060
      Visible         =   0   'False
      Width           =   11715
...
If opcion = 1 Then
   ...
   ' MsgBox "Acr_OrdenC_Otros"
        ...
        .LblCentroCosto.Caption = PnlNomCosto.Caption
        ...
        If Not RSCONSULTA.EOF Then
            ...
            .FldFchEntrega = "" & RSCONSULTA.Fields("F4FECent")
...
'            .f4emitir3.Text = "Ph: " & wtelefono & "  Fax: " & wfax
        ...
        CadSql = "SELECT EF7MEDIDAS.F7SIGMED AS F3MEDIDA, CENTROS.F3CODCLI, CENTROS.PO, IF3ORDEN.* "
        ...
        CadSql = CadSql & "WHERE (((IF3ORDEN.F4NUMORD)='" & Txt_NumOC.Text & "') AND ((IF3ORDEN.F4LOCAL)='1')) "
        CadSql = CadSql & "order by IF3ORDEN.item"
...
'        sql = sql & " " & "Where D.F4LOCAL = '1'  AND CE.F3ABREV=D.F3CENCOS And D.F4NUMORD = '" & GOC & "' ORDER BY CE.F3CODCLI"
'
'
'       If Rs.State = 1 Then Rs.Close
...
If opcion = 1 Then
    With Acr_OrdenC_Ditec
        ...
        sql = "SELECT A.F4NUMORD, A.F4CODSOLICITUD, B.F2NOMPROV,  A.F4CODSOL, A.F4CONTACTO,  B.F2TELPROV,  B.F2FAXPROV, " & _
              ...
              " FROM IF4ORDEN AS A, EF2PROVEEDORES AS B WHERE A.F4CODPRV=B.F2NEWRUC AND A.F4NUMORD = '" & GOC & _
              "' AND A.F4ESTNUL<>'S'AND A.F4LOCAL='1' ORDER BY A.F4NUMORD DESC;"
...
Dim J               As Integer
    ...
    csql = "select * from tb_cabsolicitud where cod_solicitud='" & num_solcomp & "'"
    ...
    With Grid
        ...
        'csql = "select * from tb_DETsolicitud where cod_solicitud='" & num_solcomp & "' and candis>0 "
        ...
        If Not (rsSolDet.EOF) Then
            ...
            Do While Not (rsSolDet.EOF)
                ...
                J = J + 1
                    ...
                    .Dataset.FieldValues("f3desmedida") = ObtenerCampo("ef7medidas", "f7sigmed", "f7codmed", rsSolDet!ds_unidmed & "", "T", cnn_dbbancos)
                    .Dataset.FieldValues("f3sinigv") = Val(Format(rsSolDet!Precio, "0.000"))
                    .Dataset.FieldValues("f3redondeo") = 0
                    .Dataset.FieldValues("f5afecto") = True
                    .Dataset.FieldValues("f3conigv") = 0
...
Private Sub aBoHoraEntrega_KeyDown(ByVal KeyCode As Integer, ByVal Shift As Integer)
...
'            atbmenu.Tools.ITEM("ID_Aprobacion").Visible = False
        Case "ID_Grabar":
            If Grid.Dataset.State = dsEdit Or Grid.Dataset.State = dsInsert Then
                ...
                sw_detalle = True
            End If
            If MsgBox("¿Desea Grabar la Orden de Compra?", vbQuestion + vbYesNo, wnomcia) = vbYes Then
                Me.MousePointer = vbHourglass
                GrabarOC
                ActualizarNumOrd
                Me.MousePointer = vbDefault
        ...
        Case "ID_RenovarOrden"
            ...
            Me.MousePointer = 11
            If Rs.State = 1 Then Rs.Close
            sql = "select * from if4orden where f4numord='" & Txt_NumOC.Text & "' and f4local='1'"
            Rs.Open sql, cnn_dbbancos, 3, 1
        ...
        Case "ID_Eliminar"
            ...
            If MsgBox("¿Desea Eliminar la Orden de Compra?", vbQuestion + vbYesNo, wnomcia) = vbYes Then
                ...
                Next
                csql = "delete * from if4orden where f4local='1' and f4numord='" & Txt_NumOC.Text & "'"
...
Dim cadena As String
       sql = "Select * from TB_CABSOLICITUD where Cod_Solicitud='" & Trim(ordendecompra.Txt_NumSolComp) & "'"
        ...
        If Not (prSol.EOF Or prSol.Bof) Then
            ...
            End If
            sql = "Update TB_CABSOLICITUD set NumOrden='" & Trim(cadena) & "' where Cod_Solicitud='" & Trim(ordendecompra.Txt_NumSolComp) & "'"
            cnn_dbbancos.Execute sql
            AlmacenaQuery sql, cnn_dbbancos
        End If
    prSol.Close
End Sub
...
With Grid.Columns
    If right(CmbTipDoc.Text, 2) = "02" Then
        .ColumnByFieldName("F3SINIGV").Caption = "Precio sin Retención"
        .ColumnByFieldName("F3CONIGV").Caption = "Precio con Retención"
        .ColumnByFieldName("F3IGV").Caption = "Retención"
    Else
        .ColumnByFieldName("F3SINIGV").Caption = "Precio sin I.G.V."
        .ColumnByFieldName("F3CONIGV").Caption = "Precio con I.G.V."
...
Private Sub Cmbmone_Click()
    ...
    Select Case Cmbmone.ListIndex
        Case 0:
            ...
            Me.txttotal.BackColor = vbYellow
            Me.txtigv.BackColor = vbYellow
            Me.txtbase.BackColor = vbYellow
            Me.txtmonto.BackColor = vbYellow
            Me.TxtRnd.BackColor = vbYellow
        Case 1:
            ...
            Me.txttotal.BackColor = vbGreen
            Me.txtigv.BackColor = vbGreen
            Me.txtbase.BackColor = vbGreen
            Me.txtmonto.BackColor = vbGreen
            Me.TxtRnd.BackColor = vbGreen
    End Select
    If Not inicio Then swGrabacion = True
...
Sub Limpiar()
    ...
    txt_tc.Text = Format(traerCampo("CAMBIOS", "CAMBIO", "FECHA", Me.txt_fecha.Text, ""), "0.000")
    ...
    Select Case UCase(Grid.Columns.FocusedColumn.FieldName)
        ...
        Case "F3CODPRO":
            ...
            If Len(Trim(wcodproducto)) > 0 Then
                ...
                Rem EMB Grid.Dataset.FieldValues("f5valvta") = Format(wvv_prod, "###,##0.00")
                Grid.Dataset.FieldValues("f3SINIGV") = Format(wvv_prod, "###,##0.0000")
                'Grid.Dataset.FieldValues("f3fentrega") = CVDate(Format(abofechaentrega.Value, "dd/mm/yyyy"))
                ...
                Grid.Dataset.FieldValues("f3baseimp") = Format(0, "###,##0.0000")
                Grid.Dataset.FieldValues("f3monina") = Format(0, "###,##0.0000")
                
                'Grid.Columns.FocusedIndex = 4
            End If
        Case "F5DESCOSTO":
             ' If Grid.Columns.FocusedColumn.ColumnByFieldName = "f3cencos" Then
            'MsgBox "CenCos"
            ...
            If Len(Trim(wcodcosto)) > 0 Then
                Grid.Dataset.Edit
                Grid.Columns.ColumnByFieldName("f3CODCOSTO").Value = wcodcosto
                Grid.Columns.ColumnByFieldName("f3DESCOSTO").Value = wunicosto
                Grid.Dataset.Post
...
Private Sub Txt_Fecha_Change()
    ...
    wgraba = 0
    If Not inicio Then swGrabacion = True
    txt_tc.Text = Format(ObtenerCampo("CAMBIOS", "CAMBIO", "FECHA", txt_fecha.Text, "F", cnn_dbbancos), "0.000")
...
Dim I               As Integer
    ...
    With rsOrdenDet
        sql = "SELECT * from if3orden where f4numord='" & GOC & "' AND F4local = '1'"
...
'                    atbmenu.Tools.ITEM("ID_Aprobacion").Visible = True
    ...
    With rsOrdenDet
        sql = "SELECT * from if3orden where f4numord='" & GOC & "' AND F4local = '1' ORDER BY ITEM"
        If rsOrdenDet.State = adStateOpen Then rsOrdenDet.Close
        rsOrdenDet.Open sql, cnn_dbbancos, adOpenDynamic, adLockOptimistic
        If Not (.EOF) Then
            existe = True
            ...
            Do While Not .EOF
                ...
                End If
                GRABA_REGISTRO Amov, "tmpOrdendeCompra", "A", 19, CnTmp, ""
                .MoveNext
            Loop
            Grid.Dataset.Post
            sw_nuevo_item = False
...
Dim StrCodCosto As String
    ...
    sql = "SELECT top 1 left(F4NUMORD,12) AS MAYOR FROM IF4ORDEN WHERE F4LOCAL='1' and f4numord like '%" & StrCodCosto & "' order by left(F4NUMORD,12) desc"
...
Dim amovs_cab(0 To 29)  As a_grabacion
Dim ctipo               As String
...
'        Next
    ...
    If loc = 1 Then
        ...
        Else
            rsOrdenCab.Open "SELECT F4ESTNUL,F4FALTA,F4ESTVAL from if4orden where f4numord='" & Txt_NumOC & "' AND F4LOCAL = '1'", cnn_dbbancos, adOpenDynamic, adLockOptimistic
        End If
        ...
        amovs_cab(19).campo = "F4LOCAL": amovs_cab(19).valor = "1": amovs_cab(19).TIPO = "T"
        ...
        amovs_cab(24).campo = "F4FECENT": amovs_cab(24).valor = Format(abofechaentrega.Value, "DD/MM/YYYY") & " " & Format(aBoHoraEntrega.Value, "hh:mm:ss"): amovs_cab(24).TIPO = "F"
        amovs_cab(25).campo = "F4RND": amovs_cab(25).valor = Val(Grid.Columns.ColumnByFieldName("f3redondeo").SummaryFooterValue & ""): amovs_cab(25).TIPO = "N"
        ...
        GRABA_REGISTRO amovs_cab(), "IF4ORDEN", ctipo, 29, cnn_dbbancos, "F4NUMORD = '" & Txt_NumOC.Text & "' AND F4LOCAL = '1'"
    ...
    If ctipoadm_bd = "M" Then
        If SwRenovar = True Then
            sql = ("delete from if3orden where f4numord= '" & wNumOC & "'  AND F4LOCAL = '1'")
            cnn_dbbancos.Execute sql
            AlmacenaQuery sql, cnn_dbbancos
        Else
            sql = ("delete from if3orden where f4numord= '" & Txt_NumOC.Text & "'  AND F4LOCAL = '1'")
            cnn_dbbancos.Execute sql
            AlmacenaQuery sql, cnn_dbbancos
        End If
    Else
...
'                    rsOrdenDet.Update
    ...
    If Txt_NumSolComp.Text <> "" Then
        sql = "update tb_cabsolicitud set cs_orden='" & Txt_NumOC & "' where cod_solicitud='" & _
        Txt_NumSolComp & "'"
...
'''''''''                End If
                '************NUEVO CAMBIO ********************************
                rst.Open "SELECT TB_DETSOLICITUD.COD_SOLICITUD, Sum([tb_detsolicitud].[ds_cantidad]-Val([if3orden2].[f3canpro] & '')) AS saldo " & _
                         " FROM TB_DETSOLICITUD LEFT JOIN IF3ORDEN2 ON (TB_DETSOLICITUD.cod_solicitud = IF3ORDEN2.COD_SOLICITUD) AND (TB_DETSOLICITUD.cod_producto = IF3ORDEN2.F3CODPRO) Where TB_DETSOLICITUD.COD_SOLICITUD = '" & Txt_NumSolComp & "' " & _
                         " GROUP BY TB_DETSOLICITUD.COD_SOLICITUD ", cnn_dbbancos, adOpenDynamic, adLockOptimistic
                'rst.Open "select sum(candis) as cant, sum(ds_cantidad) as ds_cantidad from tb_detsolicitud where cod_solicitud='" & Txt_NumSolComp & "'", cnn_dbbancos, adOpenDynamic, adLockOptimistic
...
Dim gcant       As Double
    ...
    If Not rsOrdenCab.EOF Then
        If MsgBox("¿Desea Anular La Orden de Compra?", vbDefaultButton2 + vbQuestion + vbYesNo, "Sistema de Logística") = 6 Then
            ...
            sql = "Update if4ORDEN set f4estado=5,f4estnul='S',f4monto=0 where F4NUMORD='" & Txt_NumOC.Text & "' and f4local='1'"
            cnn_dbbancos.Execute sql
            
            AlmacenaQuery sql, cnn_dbbancos
            
            sql = "Update if3ORDEN set f3canpro=0,f3igv=0,f3preuni=0,f5valvta=0,f3precos=0,f3total=0 where F4NUMORD='" & Txt_NumOC.Text & "' and f4local='1'"
            cnn_dbbancos.Execute sql
                ...
                With dxDBGrid1
                    ...
                    If cantidad > 0 Then
                        .Dataset.Edit
                                ...
                                ValVta = Val(Format(cantidad * Val(Format("" & .Columns.ColumnByFieldName("F3PREuni").Value, "0.000")) - totdcto, "0.00"))
                                
                                .Columns.ColumnByFieldName("F5VALVTA").Value = Format$(ValVta, "###,##0.00")
                                IGV = 0
                                .Columns.ColumnByFieldName("F3precos").Value = Val(Format("" & .Columns.ColumnByFieldName("F3PREuni").Value, "0.000"))
                                If .Columns.ColumnByFieldName("F5AFECTO").Value = "*" Then     'Afecto
                                    
                                    .Columns.ColumnByFieldName("F3precos").Value = Val(Format("" & .Columns.ColumnByFieldName("F3PREuni").Value, "0.000")) / (1 + (wwigv / 100))
...
Private Sub MODIFICAR_OC()
    ...
    With rsOrdenCab
        If rsOrdenCab.State = adStateOpen Then rsOrdenCab.Close
        sql = "SELECT * from if4orden where f4numord='" & GOC & "' AND f4LOCAL = '1'"
...
'llena variables
    ...
    End If
    'carga cabecera
    csql = "SELECT * from IF4ORDEN WHERE F4LOCAL='1' AND F4NUMORD='" & pNumOC & "'"
    Set Cab = Af.OpenSQLForwardOnly(csql, cconex_dbbancos)
    'carga detalle
    'csql = "SELECT * FROM IF3ORDEN WHERE F4LOCAL='1' AND F4NUMORD='" & pNumOC & "' order by Item"
    ...
    If Cab.RecordCount > 0 And Det.RecordCount > 0 Then
        ...
        Else
            ...
            csql = "UPDATE IF4ORDEN SET F4ESTNUL='P' WHERE F4LOCAL='1' AND F4NUMORD='" & Txt_NumOC.Text & "'"
            cnn_dbbancos.Execute csql
