...
Begin VB.Form Ayuda_Centros 
      ...
      Begin MSComctlLib.ImageList ImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":0B24
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":10BE
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":1658
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":1BF2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":218C
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":2726
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":2CC0
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":325A
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Ayuda_Centros.frx":37F4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid 
      ...
      Index           =   1
      Left            =   300
      OleObjectBlob   =   "Ayuda_Centros.frx":3D8E
      TabIndex        =   3
      Top             =   1200
      Width           =   8730
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid 
      ...
      Index           =   2
      Left            =   0
      OleObjectBlob   =   "Ayuda_Centros.frx":6F6F
      TabIndex        =   4
      Top             =   0
      Width           =   8730
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid 
      ...
      Index           =   3
      Left            =   0
      OleObjectBlob   =   "Ayuda_Centros.frx":A150
      TabIndex        =   5
      Top             =   0
      Width           =   8730
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid 
      ...
      Index           =   4
      Left            =   0
      OleObjectBlob   =   "Ayuda_Centros.frx":D331
      TabIndex        =   6
      Top             =   0
      Width           =   8730
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid 
      ...
      Index           =   5
      Left            =   0
      OleObjectBlob   =   "Ayuda_Centros.frx":10512
      TabIndex        =   7
      Top             =   0
      Width           =   8730
   End
End
Attribute VB_Name = "Ayuda_Centros"
...
Dim StrSelectInto As String

Public Property Get SelectInto() As String
    SelectInto = StrSelectInto
End Property

Public Property Let SelectInto(ByVal vNewValue As String)
    StrSelectInto = vNewValue
End Property
...
If dxDBGrid(nGridActive).Dataset.RecordCount > 0 Then
    wcodcosto = dxDBGrid(nGridActive).Columns.ColumnByFieldName("F3COSTO").Value & ""
    wdescosto = dxDBGrid(nGridActive).Columns.ColumnByFieldName("F3DESCRIP").Value & ""
    wunicosto = dxDBGrid(nGridActive).Columns.ColumnByFieldName("F3ABREV").Value & ""
    wclicosto = dxDBGrid(nGridActive).Columns.ColumnByFieldName("F3CODCLI").Value & ""
    Me.Hide
End If
End Sub
...
Case 39
    If dxDBGrid(nGridActive).Columns.FocusedIndex = (dxDBGrid(nGridActive).Columns.VisibleCount - 1) And nGridActive < 5 Then
        strDireccion = "D"
...
For i = 1 To 5
    ...
    csql = "SELECT CENTROS.F3COSTO, CENTROS.F3ABREV, CENTROS.F3DESCRIP, CENTROS.PO, CENTROS.F3CODCLI, EF2CLIENTES.F2NOMCLI "
    csql = csql & "FROM CENTROS LEFT JOIN EF2CLIENTES ON CENTROS.F3CODCLI = EF2CLIENTES.F2CODCLI "
    csql = csql & "WHERE  F3ESTNUL = 'N' AND intCodigoNivel=" & i & " "
    csql = csql & "ORDER BY CENTROS.F3COSTO"
    ...
    Case "D"
        ...
        Else
            ...
            If nGridActive = 5 Then
                Toolbar.buttons(7).Visible = True
    ...
    Case "I"
        ...
        Else
            ...
            If nGridActive = 1 Then
                Toolbar.buttons(7).Visible = False
                Toolbar.buttons(8).Visible = True
            Else
                Toolbar.buttons(7).Visible = True
                Toolbar.buttons(8).Visible = True
