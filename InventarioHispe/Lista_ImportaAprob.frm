...
Begin VB.Form Lista_ImportaAprob 
   ...
   EndProperty
   Icon            =   "Lista_ImportaAprob.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6735
   ...
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   6195
      Left            =   60
      OleObjectBlob   =   "Lista_ImportaAprob.frx":000C
      TabIndex        =   0
      Top             =   420
      Width           =   10170
   End
      ...
      Begin MSComctlLib.ImageList ImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Lista_ImportaAprob.frx":2D68
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Lista_ImportaAprob.frx":3302
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Lista_ImportaAprob.frx":389C
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Lista_ImportaAprob.frx":3E36
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "Lista_ImportaAprob"
...
With dxDBGrid1
    ...
    sql = "SELECT IMPORT_CAB.F4NUMIMP,IMPORT_CAB.F4Importacion, IIf(Len(Trim(IMPORT_CAB.F4NumOri))>0,'S','N') AS TC, "
    sql = sql & "EF2PROVEEDORES.F2NOMPROV, EF2CLIENTES.F2NOMCLI, IMPORT_CAB.F4Fecha, "
    sql = sql & "IIf(IMPORT_CAB.F4CERRADO='S','S','N') AS f4cerrado "
    sql = sql & "FROM (IMPORT_CAB LEFT JOIN EF2PROVEEDORES ON IMPORT_CAB.F4Importador = "
    sql = sql & "EF2PROVEEDORES.F2CODPROV) LEFT JOIN EF2CLIENTES ON IMPORT_CAB.F4Cliente = "
    sql = sql & "EF2CLIENTES.F2CODCLI Where (((IMPORT_CAB.F4Aprobado) = -1)) "
    sql = sql & "ORDER BY F4Importacion DESC;"


    .Dataset.Active = False
    .Dataset.ADODataset.CommandText = sql
    .Dataset.Active = True
    .KeyField = "F4Importacion"
    .M.FullExpand
End With
...
If dxDBGrid1.Dataset.RecordCount > 0 Then
    ...
    GOC = dxDBGrid1.Columns.ColumnByFieldName("F4NUMIMP").Value
