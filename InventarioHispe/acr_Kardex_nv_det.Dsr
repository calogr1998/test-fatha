VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} acr_kardex_nv_det 
   Caption         =   "Proyecto1 - acr_kardex_nv_det (ActiveReport)"
   ClientHeight    =   10680
   ClientLeft      =   0
   ClientTop       =   390
   ClientWidth     =   15360
   ...
   _ExtentX        =   27093
   _ExtentY        =   18838
   SectionData     =   "acr_Kardex_nv_det.dsx":0000
End
Attribute VB_Name = "acr_kardex_nv_det"
