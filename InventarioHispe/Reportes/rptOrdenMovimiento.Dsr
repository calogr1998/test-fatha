VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} rptOrdenMovimiento 
   Caption         =   "Logistica_Suma - rptOrdenMovimiento (ActiveReport)"
   ClientHeight    =   8895
   ClientLeft      =   855
   ClientTop       =   1710
   ClientWidth     =   12570
   Icon            =   "rptOrdenMovimiento.dsx":0000
   WindowState     =   2  'Maximized
   _ExtentX        =   22172
   _ExtentY        =   15690
   SectionData     =   "rptOrdenMovimiento.dsx":058A
End
Attribute VB_Name = "rptOrdenMovimiento"
...
Private Sub ActiveReport_ReportStart()
    ...
    Me.Caption = App.ProductName & " - Movimiento de Orden de Compra"
...
Private Sub imprimirOrdenMovimiento()
    ...
    With objAyudaOrden
        ...
        strSQL = .devuelveSQLOrdenMovimiento
    End With
