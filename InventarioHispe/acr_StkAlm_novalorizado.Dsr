VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} acr_StkAlm_novalorizado 
   Caption         =   "Reporte de Inventario"
   ClientHeight    =   8490
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   11880
   Icon            =   "acr_StkAlm_novalorizado.dsx":0000
   WindowState     =   2  'Maximized
   _ExtentX        =   20955
   _ExtentY        =   14975
   SectionData     =   "acr_StkAlm_novalorizado.dsx":000C
End
Attribute VB_Name = "acr_StkAlm_novalorizado"
...
Me.Field12.Text = Format(Val(Me.Field14.Text) + Val(Me.fldsaldo.Text) + Val(Field15.Text), "### ##0.00")
End Sub

Private Sub ReportFooter_BeforePrint()
Me.Field13.Text = Format(Val(Me.Field11.Text) + Val(Me.Field8.Text) + Val(Field15.Text), "### ### ##0.00")
End Sub
