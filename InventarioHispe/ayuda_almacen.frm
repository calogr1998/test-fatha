...
Begin VB.Form ayuda_almacen 
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_almacen.frx":058A
      ToolBars        =   "ayuda_almacen.frx":6AB6
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4215
      Left            =   120
      OleObjectBlob   =   "ayuda_almacen.frx":6BC9
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
...
Private Sub dxDBGrid1_OnDblClick()
    ...
    wnomalmacen = dxDBGrid1.Columns.ColumnByFieldName("f2nomalm").value
    txtBusqueda.Text = ""
    Me.Hide
End Sub
