...
Begin VB.Form lista_vendedores 
   ...
   Begin TrueOleDBGrid70.TDBGrid tdblista 
      ...
      Columns(0).DataField=   "F2CODUSER"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Nombres"
      Columns(1).DataField=   "F2NOMUSER"
      ...
      Splits(0)._ColumnProps(7)=   "Column(1).Width=13785"
      Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=13705"
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   9
      Tools           =   "lista_vendedores.frx":001A
      ToolBars        =   "lista_vendedores.frx":71FA
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   2895
      Left            =   45
      OleObjectBlob   =   "lista_vendedores.frx":733A
      TabIndex        =   4
      Top             =   990
      Width           =   4770
   End
...
sw_nuevo_doc = False
mant_vendedores.Show 1
Else
MsgBox "Debera de elegir un vendedor", vbInformation, "Aviso"
txtbusqueda_Change
txtbusqueda.Text = ""
...
'    adoctasctes.RecordSource = "SELECT F2CODUSER,F2NOMUSER FROM EF2USERS WHERE F2VENDEDOR='*' ORDER BY F2CODUSER"
'    adoctasctes.Refresh
With dxDBGrid1
        .DefaultFields = True
...
Private Sub FILL()
    Dim csql As String
    csql = "SELECT F2CODUSER,F2NOMUSER FROM EF2USERS WHERE F2VENDEDOR='*' ORDER BY F2CODUSER"
    
    dxDBGrid1.Dataset.Active = False
    dxDBGrid1.Dataset.ADODataset.CommandText = csql
    dxDBGrid1.Dataset.Active = True
    dxDBGrid1.KeyField = "F2CODUSER"
    CABECERA
    ...
    Select Case Tool.Id
        ...
        Case "ID_Imprimir":
            With acr_vendedores
                ...
                .DataControl1.Source = "SELECT * FROM EF2USERS WHERE F2VENDEDOR='*' ORDER BY F2NOMUSER"
...
'    For Each col In tdblista.Columns
'        col.FilterText = ""
'    Next col
...
Private Sub txtbusqueda_Change()
 ...
 dxDBGrid1.Dataset.Filter = "F2CODUSER LIKE '*" & txtbusqueda.Text & "*' OR " & " F2NOMUSER LIKE '*" & txtbusqueda.Text & "*' "
