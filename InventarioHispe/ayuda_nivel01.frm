...
Begin VB.Form ayuda_nivel01 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ayuda Lineas"
   ClientHeight    =   5925
   ClientLeft      =   3255
   ClientTop       =   1530
   ClientWidth     =   5025
   ...
   Begin ActiveToolBars.SSActiveToolBars SSActiveToolBars1 
      ...
      ToolBarsCount   =   1
      ToolsCount      =   8
      Tools           =   "ayuda_nivel01.frx":0000
      ToolBars        =   "ayuda_nivel01.frx":652C
   End
   Begin DXDBGRIDLibCtl.dxDBGrid dxDBGrid1 
      Height          =   4380
      Left            =   90
      OleObjectBlob   =   "ayuda_nivel01.frx":663F
      TabIndex        =   3
      Top             =   945
      Width           =   4770
   End
End
Attribute VB_Name = "ayuda_nivel01"
...
Private Sub FILL()
    csql = "SELECT F7CODCON,F7DESCON FROM SF7NIVEL01 ORDER BY F7CODCON"
...
Private Sub dxDBGrid1_OnDblClick()
    wcodlinea = "" & dxDBGrid1.Columns.ColumnByFieldName("F7CODCON").value
    wnomlinea = "" & dxDBGrid1.Columns.ColumnByFieldName("F7DESCON").value
    sw_limpia = True
    txtBusqueda.Text = ""
    sw_limpia = False
